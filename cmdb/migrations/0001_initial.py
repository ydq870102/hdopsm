# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-07-24 06:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assets_type', models.CharField(
                    choices=[('server', '\u670d\u52a1\u5668'), ('vmser', '\u865a\u62df\u673a'),
                             ('switch', '\u4ea4\u6362\u673a'), ('route', '\u8def\u7531\u5668'),
                             ('printer', '\u6253\u5370\u673a'), ('scanner', '\u626b\u63cf\u4eea'),
                             ('firewall', '\u9632\u706b\u5899'), ('storage', '\u5b58\u50a8\u8bbe\u5907'),
                             ('wifi', '\u65e0\u7ebf\u8bbe\u5907'), ('safe', '\u5b89\u5168\u8bbe\u5907')],
                    default='server', max_length=100, verbose_name='\u8d44\u4ea7\u7c7b\u578b')),
                ...
                ('manufacturer',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u5236\u9020\u5546')),
                (
                'provider', models.CharField(blank=True, max_length=100, null=True, verbose_name='\u4f9b\u8d27\u5546')),
                ('model',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u8d44\u4ea7\u578b\u53f7')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itsystem_name', models.CharField(max_length=100, null=True, unique=True,
                                                   verbose_name='\u4fe1\u606f\u7cfb\u7edf\u540d\u79f0')),
                ('use_for', models.CharField(max_length=255, null=True, verbose_name='\u7528\u9014')),
                ('system_framework',
                 models.CharField(max_length=100, null=True, verbose_name='\u67b6\u6784\u63cf\u8ff0')),
                ('system_manager', models.CharField(max_length=100, null=True,
                                                    verbose_name='\u4e1a\u52a1\u7cfb\u7edf\u7ba1\u7406\u5458')),
                ('system_admin', models.CharField(max_length=100, null=True,
                                                  verbose_name='\u4e1a\u52a1\u7cfb\u7edf\u8d1f\u8d23\u4eba')),
                ('interface_system',
                 models.CharField(max_length=200, null=True, verbose_name='\u4ea4\u4e92\u7cfb\u7edf')),
                ('user_of_service',
                 models.CharField(max_length=200, null=True, verbose_name='\u4f7f\u7528\u4eba\u5458')),
                ('is_untrained_person_use',
                 models.IntegerField(choices=[('0', '\u5426'), ('1', '\u662f')], default=0, null=True,
                                     verbose_name='\u662f\u5426\u666e\u901a\u7528\u6237\u4f7f\u7528')),
                ('line', models.IntegerField(
                    choices=[('0', ''), ('1', '\u7535\u4fe1'), ('2', '\u79fb\u52a8'), ('3', '\u5185\u7f51\u8054\u901a'),
                             ('4', '\u963f\u91cc\u4e91'), ('5', '\u817e\u8baf\u4e91')], default=0, null=True,
                    verbose_name='\u51fa\u53e3\u7ebf\u8def')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip',
                 models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='IP\u5730\u5740')),
                ('hostname',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u4e3b\u673a\u540d\u79f0')),
                (
                ...
                ('vcpu_number',
                 models.SmallIntegerField(blank=True, null=True, verbose_name='\u865a\u62dfCPU\u4e2a\u6570')),
                ('cpu_core', models.SmallIntegerField(blank=True, null=True, verbose_name='CPU\u6838\u6570')),
                ('disk_total',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u786c\u76d8\u603b\u91cf')),
                ('ram_total', models.IntegerField(blank=True, null=True, verbose_name='\u5185\u5b58\u603b\u91cf')),
                ('kernel',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u5185\u6838\u7248\u672c')),
                ('selinux', models.CharField(blank=True, max_length=100, null=True,
                                             verbose_name='\u662f\u5426\u5f00\u542fselinux')),
                ('swap',
                 models.CharField(blank=True, max_length=100, null=True, verbose_name='\u865a\u62dfCPU\u4e2a\u6570')),
