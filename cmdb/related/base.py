...
def get_related_column_count(model, column):
    """
    @ 对象字段统计
    :param model:
    :param column:
...
def get_related_column_enum(model, column):
    """
    @ 对象字段枚举
    :return:
    """
...
def get_related_attr(model, column):
    """
    下拉框
    :return:
    """
...
def get_related_foreignkey_count(model, column, foreignkey):
    """
    @ 对象字段枚举
    :return:
    """
